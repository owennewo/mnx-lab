...
its public API, internal structure, edge cases, and tests. By rule (see top-level `README.md`):

- A spec here may **not** be written until that module's contract exists in `../02-architecture.md`.
...
| `mnx-scenarios.md` | `mnx-scenarios` | C6 | **next** (Phase 0) — but mostly specified already in `../04-scenario-library.md` |
