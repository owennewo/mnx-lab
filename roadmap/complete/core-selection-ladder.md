...
> [spec-score-text.md](../proposed/low-priority/spec-score-text.md)'s proposed `section` field.
...
| [section] | label/color, boundaries, select-the-range (proposed field — [spec-score-text.md](../proposed/low-priority/spec-score-text.md)) |
...
- **The section rung is spec-loop evidence.** It is built on a
  ...
  ([spec-score-text.md](../proposed/low-priority/spec-score-text.md)).
