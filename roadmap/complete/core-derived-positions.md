...
> [spec-instrument-position.md](../proposed/low-priority/spec-instrument-position.md): that doc designs what the *spec*
...
[spec-instrument-position.md](../proposed/low-priority/spec-instrument-position.md) made concrete:
...
- **Converters keep writing `fret`.** MusicXML and Guitar Pro both store both, the
  ...
  exactly the migration [spec-instrument-position.md](../proposed/low-priority/spec-instrument-position.md)'s tension
...
- **The CG posting** — [spec-instrument-position.md](../proposed/low-priority/spec-instrument-position.md) owns the
