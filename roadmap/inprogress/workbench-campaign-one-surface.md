...
> **Status: in progress 2026-08-31 — campaign; items 1–5 and 7–8 built the same day, item 6 proposed (design settled, build not started).** The three-surface experiment run by
