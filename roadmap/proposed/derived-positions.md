...
> [instrument-position.md](instrument-position.md): that doc designs what the *spec*
...
[instrument-position.md](instrument-position.md) made concrete:
...
| `note.…tab.technique.*` | unchanged | graduates via [guitar-technique.md](guitar-technique.md) |
...
- **Converters keep writing `fret`.** MusicXML and Guitar Pro both store both, the
  ...
  exactly the migration [instrument-position.md](instrument-position.md)'s tension
...
([SPEC_APPROVAL.md](../complete/SPEC_APPROVAL.md) recipe).

## Staging

1. **Rules first** — this doc; update instrument-position.md's tension section to
...
- **The CG posting** — [instrument-position.md](instrument-position.md) owns the
