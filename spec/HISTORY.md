...
- **v5 (2026-08-07)** — the tab sub-namespace flattened to the adopted shape it drafts
  (roadmap/proposed/spec-instrument-position.md): `tab.position.{string,fret}` → flat `string`/`fret`
...
- **v4 (2026-07-29)** — `rehearsal` and `section` graduated out of the vendor dict into the
  standard objects proposed in roadmap/proposed/spec-score-text.md; the global-measure dict now
