...
[template](recorded-templates.md) evidence. Neural decoding currently bypasses it. A separate
[attack technique](attack-restrike.md) could supply re-strike evidence without changing the
pitch scorer. Dropout bridging, hysteresis and bend identity tracking are not implemented.
