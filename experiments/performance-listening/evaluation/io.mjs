...
export function wav(samples, rate) {
  ...
  b.write("data", 36);
  b.writeUInt32LE(samples.length * 4, 40);
  samples.forEach((x, i) => b.writeFloatLE(x, 44 + i * 4));
  return b;
}
export function readWav(file) {
  ...
  if (
    ...
    throw Error("Expected bench mono float WAV");
  return {
    sampleRate: b.readUInt32LE(24),
    samples: Float32Array.from({ length: (b.length - 44) / 4 }, (_, i) =>
      b.readFloatLE(44 + i * 4),
    ),
    hash: hash(b),
  };
}
