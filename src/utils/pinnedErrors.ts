...
/** Mirrors scripts/check-scenarios.mjs formatError — pinned fragments match this. */
...
export async function resolvePinnedErrors(
  ...
  let errors: AjvError[] = [];
  try {
    // Generated standalone Ajv module (lazy chunk; see scripts/compile-validator.mjs)
