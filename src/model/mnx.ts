...
// a stored fret is validation-only. See roadmap/complete/core-derived-positions.md.
 ...
 * instrument-neutrality change (roadmap/complete/core-derived-positions.md) an
