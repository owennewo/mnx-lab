...
//
// Usage:
//   npx tsx scripts/render-png.ts <score.mnx.json> <out.png> [--px-per-sp N]
//   npx tsx scripts/render-png.ts --all <dir-of-scenarios> <out-dir>
import fs from 'node:fs';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import { execFileSync } from 'node:child_process';
import { computePrimitives, WIDTH_SP } from '../tests/helpers/corpusPrimitives.ts';
import { renderSvgToString } from '../tests/helpers/svgString.ts';
