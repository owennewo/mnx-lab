...
//
// Usage:
//   node scripts/verify-scenarios.mjs --list             show the attention queue
//   node scripts/verify-scenarios.mjs --list --json      same, machine-readable
//   node scripts/verify-scenarios.mjs <id> [<id>...]     mark scenarios verified
//   node scripts/verify-scenarios.mjs --backfill <date>  add provenance records to
